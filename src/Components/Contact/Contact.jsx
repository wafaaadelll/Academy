...
export default function Contact() {
  AOS.init();
  return (
    <section className="bg-white pt-24 lg:pt-40 pb-6 overflow-hidden relative z-10">
      <div className="container">
        <div className="flex flex-wrap lg:justify-between -mx-4">
          <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div className="max-w-[570px] mb-12 lg:mb-0 text-left">
              <span className="block mb-4 text-green font-bold text-left">
                Contact Us
              </span>
              <h2
                className="
              ...
              <div
                className="flex mb-8 max-w-[370px] w-full"
                data-aos="fade-right"
              ...
              >
                ...
                <div className="w-full">
                  <h4 className="font-bold text-head text-xl mb-1">
                    Our Location
                  </h4>
                  <p className="text-base text-gray-500">
                    Abdel-Ghani Al-Sheikh Street, next to Hammad Cafe, Qahfa
                    District, Tanta, GharbiaGovernorate Governorate
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-gray-500">(+20)150 160 0113</p>
                </div>
              </div>
              <div
                className="flex mb-12 max-w-[370px] w-full "
                data-aos="fade-right"
                data-aos-duration="1000"
              >
                <div
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-gray-500">info@yourdomain.com</p>
                </div>
              </div>
            </div>
          </div>
